...
public class RegHandler {
    ...
    public static final RegistryObject<Item> GOLDSTICK = ITEMS.register("goldstick", DCBasicItem::new);
    public static final RegistryObject<Item> OBSIDIANSTICK = ITEMS.register("obsidianstick", DCBasicItem::new);
    public static final RegistryObject<Item> IRONDUST = ITEMS.register("irondust", DCBasicItem::new);
    public static final RegistryObject<Item> GOLDDUST = ITEMS.register("golddust", DCBasicItem::new);
    public static final RegistryObject<Item> DIAMONDDUST = ITEMS.register("diamondust", DCBasicItem::new);


    //silver
    public static final RegistryObject<Item> SILVERDUST = ITEMS.register("silverdust", DCBasicItem::new);
    public static final RegistryObject<Item> SILVERBAR = ITEMS.register("silverbar", DCBasicItem::new);
    public static final RegistryObject<Item> SILVERNUG = ITEMS.register("silvernug", DCBasicItem::new);
    //tools
    ...
    //terbium
    public static final RegistryObject<Item> TERBIUMDUST = ITEMS.register("terbiumdust", DCBasicItem::new);
    public static final RegistryObject<Item> TERBIUMBAR = ITEMS.register("terbiumbar", DCBasicItem::new);
    public static final RegistryObject<Item> TERBIUMNUG = ITEMS.register("terbiumnug", DCBasicItem::new);
    //tools
    ...
    //obsidian
    public static final RegistryObject<Item> OBSIDIANDUST = ITEMS.register("obsidiandust", DCBasicItem::new);
    public static final RegistryObject<Item> OBSIDIANBAR = ITEMS.register("obsidianbar", DCBasicItem::new);
    public static final RegistryObject<Item> OBSIDIANNUG = ITEMS.register("obsidiannug", DCBasicItem::new);
    //tools
    ...
    //hellstone
    public static final RegistryObject<Item> HELLSTONEDUST = ITEMS.register("hellstonedust", DCBasicItem::new);
    public static final RegistryObject<Item> HELLSTONEBAR = ITEMS.register("hellstonebar", DCBasicItem::new);
    public static final RegistryObject<Item> HELLSTONENUG = ITEMS.register("hellstonenug", DCBasicItem::new);
    //tools
    ...
    //hellspawn
    public static final RegistryObject<Item> HELLSPAWNBAR = ITEMS.register("hellspawnbar", DCBasicItem::new);
    public static final RegistryObject<Item> HELLSPAWNNUG = ITEMS.register("hellspawnnug", DCBasicItem::new);
    //tools
